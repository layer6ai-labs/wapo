...
_LAZY_IMPORTS = {
    ...
    "AnswerAgent": "verifiers.agents.answer_agent:AnswerAgent",
    "AnswerAgentConfig": "verifiers.agents.multi_agent_config:AnswerAgentConfig",
    "RetrieverConfig": "verifiers.agents.multi_agent_config:RetrieverConfig",
    "MultiAgentConfig": "verifiers.agents.multi_agent_config:MultiAgentConfig",
}
...
if TYPE_CHECKING:
    from .agents.answer_agent import AnswerAgent  # noqa: F401
    from .agents.multi_agent_config import (  # noqa: F401
        AnswerAgentConfig,
        MultiAgentConfig,
        RetrieverConfig,
    )
